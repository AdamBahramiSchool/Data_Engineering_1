...
def create_spark_connection():
    # Creating Spark session with Cassandra connector and Kafka dependency
    spark=None
    try:
        ...
        logging.info('spark connection created scucesfully')
    except Exception as e:
        logging.error('Couldnt create the spark connection: ', e)
